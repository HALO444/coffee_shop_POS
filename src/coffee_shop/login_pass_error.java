 ...
 * @author HALO44O
 */
public class login_pass_error extends javax.swing.JFrame {

    /**
     * Creates new form login_pass_error
     */
    public login_pass_error() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/login_pass_error.png"))); // NOI18N
        jPanel1.add(jLabel1);
        ...
        setBounds((screenSize.width-275)/2, (screenSize.height-262)/2, 275, 262);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_pass_error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new login_pass_error().setVisible(true);
            }
        });
    }
